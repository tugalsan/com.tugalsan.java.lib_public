...
public class TS_SHttpHandlerString extends TS_SHttpHandlerAbstract<String> {
    ...
    private TS_SHttpHandlerString(String slash_path, TGS_FuncMTU_OutBool_In1<TS_SHttpHandlerRequest> allow, TGS_FuncMTU_OutTyped_In1<TGS_Tuple2<TGS_FileTypes, String>, TS_SHttpHandlerRequest> request, boolean removeHiddenChars) {
        super(slash_path, allow, request);
        this.removeHiddenChars = removeHiddenChars;
    }
    final public boolean removeHiddenChars;

    public static TS_SHttpHandlerString of(String slash_path, TGS_FuncMTU_OutBool_In1<TS_SHttpHandlerRequest> allow, TGS_FuncMTU_OutTyped_In1<TGS_Tuple2<TGS_FileTypes, String>, TS_SHttpHandlerRequest> request, boolean removeHiddenChars) {
