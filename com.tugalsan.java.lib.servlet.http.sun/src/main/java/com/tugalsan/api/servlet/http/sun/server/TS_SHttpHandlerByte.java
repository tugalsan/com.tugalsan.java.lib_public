...
public class TS_SHttpHandlerByte extends TS_SHttpHandlerAbstract<byte[]> {
    ...
    private TS_SHttpHandlerByte(String slash_path, TGS_FuncMTU_OutBool_In1<TS_SHttpHandlerRequest> allow, TGS_FuncMTU_OutTyped_In1<TGS_Tuple2<TGS_FileTypes, byte[]>, TS_SHttpHandlerRequest> request, boolean removeHiddenChars) {
        super(slash_path, allow, request);
        this.removeHiddenChars = removeHiddenChars;
    }
    final public boolean removeHiddenChars;

    public static TS_SHttpHandlerByte of(String slash_path, TGS_FuncMTU_OutBool_In1<TS_SHttpHandlerRequest> allow, TGS_FuncMTU_OutTyped_In1<TGS_Tuple2<TGS_FileTypes, byte[]>, TS_SHttpHandlerRequest> request, boolean removeHiddenChars) {
