 ...
 * typedef struct _rfbCapabilityInfo { CARD32 code; // numeric identifier CARD8
 * vendorSignature[4]; // vendor identification CARD8 nameSignature[8]; //
 * abbreviated option name } rfbCapabilityInfo;
 */
public class TS_LibVncDesktopRfb_CapabilityInfo {
    ...
    public TS_LibVncDesktopRfb_CapabilityInfo(int code, String vendorSignature, String nameSignature) {
        this.code = code;
    ...
    public TS_LibVncDesktopRfb_CapabilityInfo() {
        this(0, "", "");
    }

    public TS_LibVncDesktopRfb_CapabilityInfo readFrom(TS_LibVncDesktopTransport_Transport transport) throws TS_LibVncDesktopException_Transport {
    ...
    public boolean equals(Object o) {
        ...
        var that = (TS_LibVncDesktopRfb_CapabilityInfo) o;
