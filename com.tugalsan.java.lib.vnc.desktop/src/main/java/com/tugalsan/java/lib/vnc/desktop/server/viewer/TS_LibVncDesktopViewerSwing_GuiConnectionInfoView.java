 ...
 */
public class TS_LibVncDesktopViewerSwing_GuiConnectionInfoView extends JInternalFrame implements TS_LibVncDesktopViewerSwing_GuiConnectionView {
    ...
    public TS_LibVncDesktopViewerSwing_GuiConnectionInfoView(final TS_LibVncDesktopViewerSwing_ViewerViewerEventsListener onCloseListener,
            final TS_LibVncDesktopViewerSwing_ConnectionPresenter presenter) {
        super("Connection");
...
//        }
        ...
        cancelOrCloseButton.addActionListener((ActionEvent e) -> {
            TS_LibVncDesktopViewerSwing_GuiConnectionInfoView.this.dispatchEvent(new InternalFrameEvent(
                    TS_LibVncDesktopViewerSwing_GuiConnectionInfoView.this, WindowEvent.WINDOW_CLOSING));
        });
