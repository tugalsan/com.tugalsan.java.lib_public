...
// -----------------------------------------------------------------------
//
package com.tugalsan.java.lib.vnc.desktop.server.base;

/**
 * Abstract class for operations with soft cursor positions, dimensions and hot
 * point position.
 */
public abstract class TS_LibVncDesktopDrawing_SoftCursor {
    ...
    public TS_LibVncDesktopDrawing_SoftCursor(int hotX, int hotY, int width, int height) {
        this.hotX = hotX;
        this.hotY = hotY;
